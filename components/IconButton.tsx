...
import { TouchableOpacity, StyleSheet, View, GestureResponderEvent, ViewStyle, useColorScheme } from 'react-native';
...
const CustomIconButton: React.FC<CustomIconButtonProps> = ({ onPress, children, style, showBadge = true }) => {
