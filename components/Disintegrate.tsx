    ...
    React.useEffect(() => {
        if (trigger) {
            setTimeout(() => {
                ...
                translateY.value = withTiming(-100 + Math.random() * 200, { duration: 2000 });  // Random Y movement
                translateX.value = withTiming(-100 + Math.random() * 200, { duration: 2000 });  // Random X movement
            }, delay);
        }
