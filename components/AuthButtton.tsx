...
const AuthButton = ({
    ...
    return (
        ...
        >
            ...
            <View style={{ height: "100%", width: 2, backgroundColor: theme.colors.outline, marginHorizontal: 12 }} />
...
const getStyles = (colorScheme: "light" | "dark") =>
    StyleSheet.create({
        ...
        text: {
            color: colorScheme === "dark" ? Theme.schemes.dark.outline : Theme.schemes.light.outline, // Dynamic text color
